...
include("connect.php");
$query = "SELECT * FROM songs WHERE language = 'Hindi'";
...
<head>
    ...
    <style>
        ...
        .video-player video {
            width: 100%;  /* You can also set this to a specific value like 90% */
            max-width: 900px; /* Set a maximum width */
            height: auto; /* Ensure it maintains aspect ratio */
            max-height: 700px; /* You can increase the max-height for larger videos */
        }
...
<body><a href="dashboard.php" class="back-btn">&larr; Back</a>
<nav class="navbar navbar-light bg-light">
    ...
    <div class="container">
        <h1 class="text-center my-4">BOLLYWOOD</h1>
        ...
        <div class="video-player" id="video-player">
            <h3>Now Playing:</h3>
            <video id="song-video" width="900px" controls>
